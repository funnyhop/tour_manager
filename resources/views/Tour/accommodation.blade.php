                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <select name="hotel_id" id="hotel_id" class="form-control">
                                <option selected disabled>Chọn khách sạn</option>
                        ...
                        <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                            <thead>
                                <tr>
                                    ...
                                    <th data-hide="phone">Khách sạn</th>
                            ...
                            <tbody>
                                @foreach ($list as $item)
                                    <tr>
                                        ...
                                        <td class="d-action">
                                            <a href="{{ route('accommodation.edit', ['tour_id' => $item->tour_id, 'location_id' => $item->location_id, 'hotel_id' => $item->hotel_id]) }}"
                                                class="btn-warning btn btn-xs"><i class="fa fa-pencil-square-o"
                                                    aria-hidden="true"></i></a>
                                            <form
                                                action="{{ route('accommodation.destroy', ['tour_id' => $item->tour_id, 'location_id' => $item->location_id, 'hotel_id' => $item->hotel_id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')

                            ...
                            <tbody>
                                @foreach ($list as $item)
                                    <tr>
                                        ...
                                        <td class="d-action">
                                            <a href="{{ route('eat.edit', ['tour_id' => $item->tour_id, 'location_id' => $item->location_id, 'restaurant_id' => $item->restaurant_id]) }}"
                                                class="btn-warning btn btn-xs"><i class="fa fa-pencil-square-o"
                                                    aria-hidden="true"></i></a>
                                            <form
                                                action="{{ route('eat.destroy', ['tour_id' => $item->tour_id, 'location_id' => $item->location_id, 'restaurant_id' => $item->restaurant_id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')

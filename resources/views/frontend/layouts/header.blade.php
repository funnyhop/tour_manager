    ...
    <div class="container">
        <div class="row">
            ...
            <div id="search" class="col-md-7 col-sm-12 col-xs-12 mx-auto">
                ...
                <form action="{{ route('search_item') }}" class="pt-4" method="get">
                    <input class="input-search" placeholder="Nhập từ khóa ..." type="search" name="key">
            ...
            <div id="cart" class="col-md-2 col-sm-12 col-xs-12">
                ...
                <button class="btn-cart cart-button">
                    <img width="40" height="40" src="https://img.icons8.com/ios-filled/50/user-female-circle.png"
